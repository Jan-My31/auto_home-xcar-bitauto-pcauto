...
class Autohome_MysqlPipeline(object):
    ...
    def do_insert(self, cursor, item):
        sql = 'INSERT INTO autohome_list_SKODA(bbs_name,posts,reply,page_view,posted_name,posted_time,posts_id,reply_time,name_id,content,name,model,posts_url)VALUES(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)'
