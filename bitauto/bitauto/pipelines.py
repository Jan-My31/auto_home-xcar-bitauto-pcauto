...
class BitautoPipeline(object):
    def process_item(self, item, spider):
        return item

class Bitauto_MysqlPipeline(object):
    ...
    def do_insert(self, cursor, item):
        ...
        # sql ='INSERT INTO bitauto_list(module,module_url,bbs_name,lasttopicnum,lastbbsnum,posts,posts_url,reply,page_view,posted_name,posted_time,finally_reply,reply_time)VALUES(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)'
        #
        args = (
            # item['module'],
            # item['module_url'],
